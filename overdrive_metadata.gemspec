...
Gem::Specification.new do |s|
  ...
  s.version = "1.0.0.20111121154633"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Mark Cooper"]
  s.date = %q{2011-11-21}
  s.description = %q{Generate marc records from Overdrive provided metadata spreadsheets.}
  ...
  s.summary = %q{Generate marc records from Overdrive provided metadata spreadsheets.}
